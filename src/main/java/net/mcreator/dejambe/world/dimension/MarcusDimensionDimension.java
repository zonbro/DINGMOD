...
package net.mcreator.dejambe.world.dimension;
...
import net.mcreator.dejambe.item.MarcusDimensionItem;
import net.mcreator.dejambe.block.SaltBlockBlock;
...
public class MarcusDimensionDimension extends DejambeModElements.ModElement {
	@ObjectHolder("dejambe:marcus_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public MarcusDimensionDimension(DejambeModElements instance) {
		super(instance, 9);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(SaltBlockBlock.block).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dejambe:marcus_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("marcus_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("marcus_dimension_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("marcus_dimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new MarcusDimensionItem().setRegistryName("marcus_dimension"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("dejambe:marcus_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dejambe:marcus_dimension")));
				} else {
					entity.func_242279_ag();
